...
public class BaseTest implements IDriver {
    ...
    private void setAppiumDriver(String platformName, String deviceName, String udid,
        ...
        if (app.endsWith(".apk")) capabilities.setCapability("app",
                (new File(app)).getAbsolutePath());

        capabilities.setCapability("browserName", browserName);
        capabilities.setCapability("chromedriverDisableBuildCheck", "true");

        // Capabilities for Android Native tests on EPAM Mobile Cloud
        capabilities.setCapability("appPackage", appPackage);
        capabilities.setCapability("appActivity", appActivity);

        // Capabilities for iOS Native tests on EPAM Mobile Cloud
